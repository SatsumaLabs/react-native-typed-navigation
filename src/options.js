...
import type {ComponentId, ComponentIntent, ComponentClassKey, ButtonKey} from './keys';
...
export interface OptionsTopBarButton {
    id: ButtonKey; //Button id for reference press event
...
export interface OptionsTopBar {
    ...
    leftButtons?: OptionsTopBarButton[]; //List of buttons to the left
    rightButtons?: OptionsTopBarButton[]; //List of buttons to the right
...
export interface OptionsCustomTransitionAnimation {
  ...
  fromId: string; //Transition from element Id
  toId: string; //Transition to element Id
  startDelay?: number; //Animation delay
